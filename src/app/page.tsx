...
export default function Home() {
  return (
    <Template>
      <Image
        className="dark:invert animate-in fade-in duration-1000"
        ...
        priority
      />
      <ol className="list-inside list-decimal text-sm text-center sm:text-left font-[family-name:var(--font-geist-mono)] animate-in slide-in-from-left duration-500">
        <li className="mb-2">
